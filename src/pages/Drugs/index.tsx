    ...
    return (
      <Spin spinning={initLoading} wrapperClassName="spin">
        <div className="Drugs">
          ...
          >
            <Spin spinning={uploadloading} delay={500}>
              ...
              <Button
                ...
                onClick={() => {
                  window.open(
                    'http://139.224.193.145:7744/Upload/导入数据-药品名称.xlsx?id=10000',
                  );
                }}
              >
                下载模板
          ...
          <div>
            <div style={{ marginBottom: 10 }}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item>药品信息维护</Breadcrumb.Item>
              </Breadcrumb>
            </div>
          </div>
          ...
          <div className="tool" style={{ marginBottom: 15 }}>
            <Space>
              <Button
                type="primary"
